...
class milling_workpiece:
    def __init__(self, xy_workpiece=np.array([[0, -76, -76, 0], [0, 0, -100, -100]]), axial_cutting_depth=1.):
        self.number_of_teeth = 1 # 4
        self.helix_angle = 45 / 180 * m.pi#48 / 180 * m.pi
        self.diameter_end_mill = 20.0 #10.
        self.radius_tool = self.diameter_end_mill / 2
        self.axial_cutting_depth = axial_cutting_depth
        self.max_layer_rot_between_slices = 10 / 180 * m.pi
        ...
        self.cutting_force_coefficient_Ktc = 1930.4
        self.cutting_force_coefficient_Krc = 1159.6
        self.cutting_force_coefficient_Kac = 200.6
